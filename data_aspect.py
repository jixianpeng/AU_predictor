...
import json
import torchvision
root_path='D:/DATASET/aff_wild2/crop and aligned/cropped_aligned/'
root_path_s='D:/DATASET/aff_wild2/crop and aligned/S/'
root_path_boder='D:/DATASET/aff_wild2/crop and aligned/S_boder/'
train_path='D:/DATASET/aff_wild2/annotations/AU_Set/Training_Set/'
valid_path='D:\DATASET/aff_wild2/annotations/AU_Set/Validation_Set/'
file_list=[]
dir_list=[]
...
def load_json_landmark():
    landmark_dataset={}
    for i in os.listdir('D:/DATASET/aff_wild2/crop and aligned/' + 'landmark/'):
        if i.endswith('.json'):
            print(i)
            temp = json.load(open('D:/DATASET/aff_wild2/crop and aligned/' + 'landmark/' + i, 'r+'))
